...
class ToursFilterPeople extends PureComponent {
  static propTypes = {
  ...
  renderSelectedChild(item, index) {
    ...
    return (
      <div key={item.key} className='tours-filter__button tours-filter__button--light-orange'>
        {item.name}
...
export default ToursFilterPeople;
